    ...
    return Dialog(
      ...
      child: IntrinsicHeight(
        child: Container(
          ...
          padding:
              const EdgeInsets.only(left: 16, right: 16, top: 32, bottom: 60),
          child: Column(
            spacing: 32,
            children: [
              Text(
                              ...
                              onTap: () {
                                ...
                                showCupertinoModalPopup<void>(
                                  ...
                                  builder: (modalContext) {
                                    final screenSize =
                                        MediaQuery.sizeOf(modalContext);
                                    return ImageResizer(
                          ...
                          if (!readOnly)
                            ListTile(
                              ...
                              onTap: () async {
                                ...
                                if (await config.shouldRemoveImageCallback
                                        ?.call(imageSource) ==
                                    false) {
                                  return;
                                }
                                ...
                                await config.onImageRemovedCallback
                                    .call(imageSource);
                              },
                            ),
                          ListTile(
                            ...
                            onTap: () async {
                              ...
                              if (kIsWeb) {
                                messenger.showSnackBar(SnackBar(
                                    content: Text(
                                        localizations.successImageDownloaded)));
                                return;
                              }
                              ...
                              if (result.isGallerySave) {
                                messenger.showSnackBar(SnackBar(
                                  content: Text(
                                      localizations.successImageSavedGallery),
                                  action: SnackBarAction(
                                    label: localizations.openGallery,
                                    onPressed: () => QuillNativeProvider
                                        .instance
                                        .openGalleryApp(),
                                  ),
                                ));
                              ...
                              if (isDesktopApp) {
                                ...
                                messenger.showSnackBar(
                                  SnackBar(
                                    content:
                                        Text(localizations.successImageSaved),
                                    ...
                                    action: defaultTargetPlatform ==
                                            TargetPlatform.macOS
                                        ? SnackBarAction(
                                            label: localizations.openFile,
                                            onPressed: () => launchUrl(
                                                Uri.file(imageFilePath)),
                                          )
                                        : SnackBarAction(
                                            label:
